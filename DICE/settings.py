...
SESSION_CONFIG_DEFAULTS = dict(
    ...
    full_name = '',
    eMail = '',
    study_name = "Studio sull'Esperienza sui Social Media   ",
    channel_type = 'Instagram',
    survey_link = 'https://polimi.eu.qualtrics.com/jfe/form/SV_00B0HN61LM8IRqC', #https://polimi.eu.qualtrics.com/jfe/form/SV_eeS0tFcikR5hSrs
    ...
    data_path = "https://raw.githubusercontent.com/atarikozbek/DICE/thesisTarik/DICE/DICE/static/data/italianfeed.csv", #GLORIA REPO
    delimiter=',',
    sort_by='datetime',
